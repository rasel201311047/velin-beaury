...
export default function page() {
         const [showValue, setShowValue] = useState({ mail:false,pass:false });
    return (
                    ...
                    <form className='lg:w-4/12 md:w-6/12 w-[95%] mx-auto'>
                        ...
                        <div className='flex items-center gap-2 mb-2'>
                            ...
                            <button onClick={() => setShowValue({ ...showValue, mail: !showValue.mail }) }>
                             ...
                             <div className={`${showValue.mail?'':'hidden'} text-xs font-roboto text-gray-500`}>(mandatory-Enter your Email)</div>
                        </div>
                        ...
                        <div className='flex items-center gap-2 mt-2 mb-2'>
                            ...
                            <button onClick={() => setShowValue({ ...showValue, pass: !showValue.pass }) }>
                             ...
                             <div className={`${showValue.pass?'':'hidden'} text-xs font-roboto text-gray-500`}>(mandatory-Enter your Password)</div>
                        </div>
